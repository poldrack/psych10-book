...
```{r carsDf, echo=FALSE,fig.cap="A view of the cars_df data frame generated by the View() function.",fig.width=5}
...
The downloaded binary packages are in
	/var/folders/n9/8g4nr7h903l13tltdm4yhdkh0000gq/T//RtmpniKMQw/downloaded_packages
