...
$$
In this case, the value is`r I(corXY)`. We can also compute the correlation value easily using the `cor()` function in R, rather than computing it by hand.
...
html_print(add_mathjax(grViz(graph))) %>%
...
"
html_print(add_mathjax(grViz(latent_graph))) %>%
