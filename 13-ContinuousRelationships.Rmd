...
```{r gini0,fig.cap="Lorenz curve for Gini index of zero (i.e. perfect equality).",fig.width=8,fig.height=8,out.height='50%'}
# Create Lorenz curve for Gini index of zero (i.e. perfect equality)
...
The p-value computed using randomization is reasonably similar to the answer give by the t-test.
...
- [The Book of Why](http://bayes.cs.ucla.edu/WHY/) - an excellent introduction to the ideas behind causal inference.
