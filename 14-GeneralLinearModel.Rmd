...
```{r StudytimeGrades, echo=FALSE,fig.cap='Relation between study time and grades'}
...
```{r GLMmatrix, echo=FALSE,fig.width=4, fig.height=4,fig.cap="A depiction of the study time data in terms of matrix algebra."}
...
```{r StudytimeGradesPrior, echo=FALSE,fig.cap='The relationship between study time and grades, with color identifying whether each student had taken a previous course on the topic'}
...
```{r CaffeineSpeaking, echo=FALSE,fig.cap='The relationship between caffeine and public speaking'}
set.seed(1234567)
...
```{r CaffeineSpeakingAnxiety,echo=FALSE,fig.cap='The relationship between caffeine and public speaking, with anxiety represented by the color of the data points'}
df <- 
  df %>% 
...
```{r CaffeineAnxietyInteraction, echo=FALSE,fig.cap='The relationship between public speaking and caffeine, including an interaction with anxiety.  This results in two lines that separately model the slope for each group.'}
