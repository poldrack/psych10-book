...
```{r ReliabilityValidity, echo=FALSE,fig.width=6, fig.height=6,fig.cap="A figure demonstrating the distinction between reliability and valdity.  Copyright Nevit Dilmen/CC-BY-SA-3.0",fig.width=8,fig.height=8,out.height='50%'}
