...
In general, most programming languages treat truth values and binary numbers equivalently. The number 1 is equal to the logical value ```TRUE```:
...
And the number zero is equal to the logical value ``FALSE``:
```
> FALSE == 0
[1] TRUE
```
