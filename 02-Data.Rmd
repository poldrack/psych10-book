...
```{r ReliabilityValidity, echo=FALSE,fig.cap="A figure demonstrating the distinction between reliability and valdity. Based on  ",fig.width=6,fig.height=6,out.height='33%'}
...
p1=ggplot(plotDf,aes(X_RelVal,Y_RelVal)) +
  gg_circle(r=4, xc=0.0, yc=0.0,size=5,color='red') + 
  gg_circle(r=3, xc=0.0, yc=0.0,size=5,color='red') + 
  gg_circle(r=2, xc=0.0, yc=0.0,size=5,color='red') + 
  gg_circle(r=1, xc=0.0, yc=0.0,size=5,color='red',fill='red') + 
...
plot_grid(p1,p2,p3,p4,ncol=2,label_size=18,
