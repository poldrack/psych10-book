...
This shows that the mean has a pretty substantial amount of error -- any data point will be about 27 cm from the mean on average. 
...
```{r childHeightLine,fig.cap="Height of children in NHANES, plotted as a function of age, with the best fitting model using only height showing in blue. Notice that the line systematically misses the data points."}
...
```{r childHeightConstLine,fig.cap="Height of children in NHANES, plotted as a function of age, with the best fitting model including both age and a constabnt shown in blue."}
...
```{r crimeMapRaw,fig.cap="A map of the US with crime rates depicted in color.  Example adapted from https://cran.r-project.org/web/packages/fiftystater/vignettes/fiftystater.html"}
library(mapproj)
library(fiftystater)
