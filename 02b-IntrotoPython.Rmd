...
car_model = ["Ford Fusion",
               "Hyundai Accent",
               "Toyota Corolla"]
car_price = [25000, 16000, 18000]
car_mileage = [27, 36, 32]

cars_df = pandas.DataFrame({'model': car_model, 
                      'price': car_price, 
                      'mileage':car_mileage})
print(cars_df)
```
...
```{python carsDf, fig.cap="A view of the cars data frame generated by the View() function.",fig.width=5}

import matplotlib.pyplot as plt
import matplotlib.image as mpimg
img=mpimg.imread("images/cars_df.png")
plt.imshow(img)
