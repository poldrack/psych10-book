...
```{r chartJunk,echo=FALSE,fig.width=8,fig.cap="An example of chart junk."}
...
```{r pieChart,echo=FALSE,fig.cap="An example of a pie chart, highlighting the difficult in apprehending the relative volume of the different pie slices.", fig.width=8}
