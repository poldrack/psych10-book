...
if (!require("modelr")) install.packages("modelr",repos="https://cran.rstudio.com",dependencies=TRUE)
...
if (!require("readr")) install.packages("readr",repos="https://cran.rstudio.com",dependencies=TRUE)
