...
```{r AtoZBMIChangeDensity,echo=FALSE,fig.cap="Violin plots for each condition, with the 50th percentile (i.e the median) shown as a black line for each group.", fig.width=4, fig.height=4}
